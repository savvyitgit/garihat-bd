        ...
        {step === 1 && (
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input name="model" value={form.model} onChange={handle} required
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input name="year" value={form.year} onChange={handle} required
            ...
            <div>
              ...
              <select name="fuel" value={form.fuel} onChange={handle}
                className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm">
                <option value="Petrol">Petrol</option>
                <option value="Diesel">Diesel</option>
                <option value="Hybrid">Hybrid</option>
                <option value="Electric">Electric</option>
                <option value="CNG">CNG</option><option value="Octane">Octane</option>
              </select>
            </div>

            <button onClick={next} disabled={!form.brand}
              className="bg-[#DB1408] text-white py-3 rounded-xl font-bold hover:bg-red-700 transition disabled:opacity-50">
              Next →
            </button>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input name="price" value={form.price} onChange={handle} required
            ...
            <div>
              ...
              <textarea name="description" value={form.description} onChange={handle} required
                rows={5} placeholder="Describe your vehicle in detail. Include condition, features, history..."
                className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm" />
            </div>

            <div className="flex gap-3">
              <button onClick={back}
                className="flex-1 border-2 border-gray-300 text-gray-600 py-3 rounded-xl font-bold hover:border-[#DB1408] hover:text-[#DB1408] transition">
                ← Back
              </button>
              <button onClick={next} disabled={!form.price}
                className="flex-1 bg-[#DB1408] text-white py-3 rounded-xl font-bold hover:bg-red-700 transition disabled:opacity-50">
                Next →
              </button>
            </div>
          </div>
        ...
        {step === 3 && (
          <form onSubmit={submit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input name="sellerName" value={form.sellerName} onChange={handle} required
            ...
            <div>
              ...
              <input name="sellerPhone" value={form.sellerPhone} onChange={handle} required
            ...
            <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-500">
              ...
              <p>৳ {parseInt(form.price).toLocaleString()} — {form.location}</p>
            ...
            <div className="flex gap-3">
              ...
              <button type="submit" disabled={loading || !form.sellerName || !form.sellerPhone}
                className="flex-1 bg-[#DB1408] text-white py-3 rounded-xl font-bold hover:bg-red-700 transition disabled:opacity-50">
